...
export default function TechStackSection() {
  return (
    <section>
      ...
      {/* Skill cloud */}
      <div className="bg-white border border-google-grey-200 rounded-xl p-6 hover:shadow-google-hover transition-shadow">
      ...
      <h2 className="text-lg font-semibold text-google-grey-900 mt-10 mb-4">
        Proficiency
      </h2>
        ...
        {[
          ...
          >
            <div className="flex justify-between mb-2">
              <span className="text-sm font-medium text-google-grey-800">
                {item.category}
              </span>
              <span className="text-sm text-google-grey-500">
                {item.level}%
              </span>
            </div>
            <div className="w-full bg-google-grey-100 rounded-full h-2">
              <div
